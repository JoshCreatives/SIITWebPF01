  ...
  const featuredPosts = [
    {
      ...
      excerpt: "Expanding our reach to provide quality education in the south of Metro Manila with state-of-the-art facilities and modern learning spaces.",
      author: "Admin",
      date: "March 15, 2024",
  ...
  const blogPosts = [
    {
      ...
      excerpt: "Our students showcase excellence in technology and innovation on the national stage, bringing home top honors in software development.",
      author: "Events Team",
      date: "March 12, 2024",
    ...
    },
    {
      ...
      excerpt: "Leading companies participate in our annual career fair, offering opportunities to our graduates and forming strategic partnerships.",
    ...
    },
    {
      ...
      excerpt: "SIIT researchers develop new AI-powered learning tools to enhance student engagement and personalized learning experiences.",
    ...
    },
    {
      ...
      excerpt: "SIIT graduate launches successful tech startup, creating innovative solutions for environmental challenges.",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-8">
                ...
                <h2 className="text-2xl font-bold mb-4 text-green-400">
                  <a href={`/blog/${post.id}`} className="hover:text-green-500 transition-colors">
                    {post.title}
                  </a>
                </h2>
